...
camera_set_view_size(view_camera[0], 256, 240); //See common resolution sizes above.
...
scr_CRT_init_shader(view_camera[0], false, 0.12, false, true, true, 0.03, 80.0, 1.0, true, 0.175);